        ...
        <div className="container-x">
          ...
          <Reveal delay={0.05}>
            <h1 className="section-title mt-4 max-w-3xl">
              Hablemos sobre tu marca. <span className="text-indigo">Te respondemos en 24h.</span>
            </h1>
          </Reveal>
        </div>
      </section>
        ...
        <div className="container-x grid gap-8 md:grid-cols-2">
          <Reveal>
            <div className="rounded-2xl border border-slate-line bg-mist/40 p-8">
              ...
              <a href={`mailto:${f.email}`} className="mt-4 block text-sm font-semibold text-indigo">
                {f.email}
              </a>
              <a
