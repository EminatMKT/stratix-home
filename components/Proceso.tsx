        ...
        <div className="mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {p.steps.map((s, i) => (
            <Reveal key={s.n} delay={i * 0.08}>
              <div className="relative h-full rounded-2xl border border-slate-line bg-mist/40 p-7">
                <span className="font-display text-5xl font-extrabold text-indigo/40">{s.n}</span>
                ...
                {i < p.steps.length - 1 && (
                  <span className="absolute right-5 top-9 hidden text-indigo lg:block">
