        ...
        <div className="mt-16 grid gap-5 md:grid-cols-2 lg:grid-cols-5">
          {v.pillars.map((p, i) => (
            <Reveal key={p.title} delay={i * 0.06}>
              <div className="h-full rounded-2xl border border-white/10 bg-white/5 p-7 backdrop-blur transition hover:border-indigo/50 hover:bg-white/10">
                <span className="grid h-10 w-10 place-items-center rounded-lg bg-indigo/20 text-indigo-200 font-display text-base font-bold">
